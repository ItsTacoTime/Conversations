...
/**
 * Added by hlew on 8/11/15.
 * Used with permission from
 * https://github.com/BurntBrunch/android-WrappingSlidingPane/blob/master/WrappingSlidingPaneLayout.java
 *
...
public class WrappingSlidingPaneLayout extends ViewGroup {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        */
        // Remove the ability to drag the child view.
